...
function applyUniforms(program, o) {
  ...
  u.uGrainAnimated.value = o.grainAnimated ? 1 : 0;
  u.uContrast.value = o.contrast;
  u.uGamma.value = o.gamma;
  u.uSaturation.value = o.saturation;
  u.uCenterOffset.value[0] = o.centerX;
  u.uCenterOffset.value[1] = o.centerY;
